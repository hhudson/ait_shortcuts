...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19532605421196221)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19532903954196221)
,p_plug_template_id=>wwv_flow_imp.id(19532605421196221)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19533258341196221)
,p_plug_template_id=>wwv_flow_imp.id(19532605421196221)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19533577062196221)
,p_plug_template_id=>wwv_flow_imp.id(19532605421196221)
,p_name=>'Sub Regions'
