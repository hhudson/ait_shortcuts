...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19558164938196235)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19558433467196236)
,p_plug_template_id=>wwv_flow_imp.id(19558164938196235)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19558774129196236)
,p_plug_template_id=>wwv_flow_imp.id(19558164938196235)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19559035675196236)
,p_plug_template_id=>wwv_flow_imp.id(19558164938196235)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19559370189196236)
,p_plug_template_id=>wwv_flow_imp.id(19558164938196235)
,p_name=>'Sub Regions'
