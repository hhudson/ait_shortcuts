...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(19595735201196258)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19596017647196258)
,p_plug_template_id=>wwv_flow_imp.id(19595735201196258)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(19596380976196258)
,p_plug_template_id=>wwv_flow_imp.id(19595735201196258)
,p_name=>'Tabs'
